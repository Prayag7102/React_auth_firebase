  ...
  return (
    <div className="relative mt-5">
      ...
      <div className="flex min-h-full flex-col justify-center px-6 py-6 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm border p-5 bg-white rounded-md shadow-lg">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <p className='text-center'>
              you don't have an account <Link className='text-indigo-600' to="/register">Register</Link>
            </p>
          </form>
