...
export default function Footer() {
  const navItems1 = [
    { name: "Product", link: "#", isHeading: true },
    { name: "Features", link: "#" },
  ...
  const navItems2 = [
    { name: "Company", link: "#", isHeading: true },
    { name: "Privacy", link: "#" },
    { name: "Terms of Service", link: "#" },
  ];
  const navItems3 = [
    { name: "Developers", link: "#", isHeading: true },
    { name: "Developers API", link: "#" },
  ...
  return (
    <div>
      <footer className="bg-gray-900 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-center">
        
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <NavSection items={navItems1} />
            <NavSection items={navItems2} />
            <NavSection items={navItems3} />
        ...
        <div className="mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center">
          {" "}
          © 2024 prayag. All rights reserved.
        </div>
      </footer>
